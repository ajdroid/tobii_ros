...
if __name__ == "__main__":
    ...
    # Very important property to reduce the amount of h264 decoding errors
    # This property is only availible in opencv 3 and later versions
    ...
    while running:
        ...
        cv2.putText(frame,'O',(int(gp[0] * 1920),int(gp[1] * 1080)), font, 1,(255,255,255),2)
